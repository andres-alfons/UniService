...
// Formulario de publicación de servicios para usuarios autenticados.
// Recopila título, descripción, categoría, precio, universidad, tipo de
// contacto, modalidad y disponibilidad; valida los campos y envía al backend.
// ─────────────────────────────────────────────────────────────────────────────
...
// Componente principal del formulario de publicación
export default function SeccionPublicar({ onPublicado }) {
  // Estado del formulario y de la interfaz
  ...
  // Actualiza cualquier campo del formulario por su nombre
  ...
  // Maneja la selección del tipo de universidad (UPC, otra, ninguna)
  ...
  // Campo libre para escribir otra universidad
  ...
  // Valida el formato de teléfono (10 dígitos) o correo electrónico
  ...
  // Envía el formulario: valida, construye el payload y hace POST al backend
  const handleSubmit = async (e) => {
    ...
    // Mapea las opciones de modalidad y disponibilidad a valores numéricos para la BD
    ...
    // Construye el objeto del nuevo servicio
    const nuevoServicio = {
  ...
  return (
    <>
        ...
        <div className="publicar-wrapper">
          ...
          <div className="caja-formulario publicar-form-dinamico reveal delay-3">
            ...
            <fieldset className="contacto-fieldset">
              ...
              {/* Muestra campo de texto si se selecciona "otra" universidad */}
            ...
            {/* ── Información de contacto (WhatsApp o correo) ── */}
            <fieldset className="contacto-fieldset">
              ...
              {/* Input dinámico según el tipo de contacto seleccionado */}
              {tipoContacto && (
                <div className="form-grupo contacto-input-animado">
                  ...
                  <div className="input-with-icon">
                    ...
                    <input
                      ...
                      value={form.contacto}
                      onChange={(e) => {
                        // Para teléfono solo permite dígitos, máximo 10
                  ...
                  {/* Indicador visual de validación para correo */}
                  ...
                  {/* Indicador visual de validación para teléfono */}
            ...
            <fieldset>
              ...
              <div className="form-grupo" style={{ marginBottom: "20px" }}>
                ...
                {/* Radio buttons con íconos para modalidad */}
              ...
              <div className="form-grupo" style={{ marginBottom: "20px" }}>
                ...
                {/* Radio buttons con íconos para disponibilidad */}
                <div className="check-group button-style">
              ...
              {/* Botones de acción: publicar y limpiar */}
      ...
      {/* Modal de error con el mensaje correspondiente */}
      {modalError && (
  ...
  const handleSubmit = async (e) => {
    ...
    const errorContacto = validarContacto();
    if (errorContacto) { setModalError(errorContacto); return; }
    if (Number(precio) < 1000) { setModalError("El precio minimo debe ser \,000 COP."); return; }
